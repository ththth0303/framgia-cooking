                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="createItem">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="price" class="form-control" v-model="newItem.email" />
                                <span v-if="formErrors['price']" class="error text-danger">@{{ formErrors['price'] }}</span>
                            </div>

                            <div class="form-group">
                                <label for="content">Level:</label>
                                <textarea name="content" class="form-control" v-model="newItem.level_id"></textarea>
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="updateItem(fillItem.id)">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="form-control" v-model="fillItem.level_id"></textarea>
